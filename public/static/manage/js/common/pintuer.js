	...
	$pintuercheck=function(element,type,value){
		...
		switch(type){
		    case "required": return /[^(^\s*)|(\s*$)]/.test($pintu); break;
		        // case "time": return /^[0-9]{1,2}:[0-5][0-9][:]{0,1}([0-5][0-9]){0,1}$/.test($pintu); break;
		    case "datetime": return /^[0-9]{4}-[1|0][0-9]-[0-3][0-9]\s+[0-9]{1,2}:[0-5][0-9][:]{0,1}([0-5][0-9]){0,1}$/.test($pintu); break;
		    case "timeformat": return /^[0-9]{1,2}:[0-5][0-9][:]{0,1}([0-5][0-9]){0,1}$/.test($pintu); break;
			...
			case "money":return /^\d+(\.\d+)?$/.test($pintu);break;
